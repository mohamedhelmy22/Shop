                    ...
                    <div class="card-body p-4">
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="col-md-2 col-lg-2 col-xl-2">
                                <img src="<?php echo e(Storage::url($product_cart->Product->image)); ?>" class="img-fluid rounded-3"
                                    alt="Cotton T-shirt">
                            </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-4">
                    <a href="<?php echo e(route('checkout.index')); ?>"
                        class="btn btn-success "><?php echo e(trans('website_trans.checkout')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('website.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop\resources\views/website/cart/index.blade.php ENDPATH**/ ?>