...
unset($__errorArgs, $__bag); ?>" name="fname" value="<?php echo e(old('fname')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>" name="lname" value="<?php echo e(old('lname')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>" name="country" value="<?php echo e(old('country')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>" name="city" value="<?php echo e(old('city')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="address1" class="col-md-4 col-form-label text-md-end"><?php echo e(__('address')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="address1" value="<?php echo e(old('address1')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <label for="address2" class="col-md-4 col-form-label text-md-end"><?php echo e(__('address 2')); ?></label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="pincode" class="col-md-4 col-form-label text-md-end"><?php echo e(__('pincode')); ?></label>
                                <input id="pincode" type="text" class="form-control <?php $__errorArgs = ['pincode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="pincode" value="<?php echo e(old('pincode')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end"><?php echo e(__('re-Password')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\elalrayanshop\resources\views/auth/register.blade.php ENDPATH**/ ?>